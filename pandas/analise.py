...
# 5. Preencher dados faltantes com a média (apenas para colunas numéricas)
df['Idade'] = df['Idade'].fillna(df['Idade'].mean())
print("DataFrame com valores numéricos faltantes preenchidos com a média:")
print(df)
print("\n")

# 6. Preencher dados faltantes com o valor anterior (forward fill)
df_ffill = df.fillna(method='ffill')
print("DataFrame com forward fill:")
print(df_ffill)
print("\n")

# 7. Preencher dados faltantes com o valor seguinte (backward fill)
